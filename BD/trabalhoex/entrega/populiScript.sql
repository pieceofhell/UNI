...
-- Populando a tabela Universidade com instituições reais
INSERT INTO
...
-- Populando a tabela Biblioteca com bibliotecas reais
INSERT INTO
    `Biblioteca` (
        `idBiblioteca`,
        `Nome`,
...
-- Populando a tabela Funcionario com nomes fictícios
INSERT INTO
    `Funcionario` (
        `CPF`,
        `biblioteca_id`,
...
-- Populando a tabela Livro com livros fictícios e atributos Titulo e Autor
INSERT INTO
    `Livro` (
        `idLivro`,
        `dataPublicacao`,
...
-- Populando a tabela Usuario com nomes fictícios
INSERT INTO
...
-- Populando a tabela Compra com dados fictícios
INSERT INTO
    `Compra` (
        `dataCompra`,
        `CPF_Funcionario`,
...
-- Populando a tabela Emprestimo com dados fictícios
INSERT INTO
    `Emprestimo` (
        `CPF_Funcionario`,
        `CPF_Usuario`,
...
-- Populando a tabela Personagem com personagens fictícios
INSERT INTO
...
-- Populando a tabela LivrosEmBibliotecas com dados fictícios
INSERT INTO
...
-- Populando a tabela PersonagensEmLivros com dados fictícios
INSERT INTO
...
-- Populando a tabela Universidade com mais instituições reais e fictícias
INSERT INTO
    `Universidade` (`idUniversidade`, `Nome`)
VALUES
...
-- Populando a tabela Biblioteca com mais bibliotecas reais e fictícias
INSERT INTO
    `Biblioteca` (
        `idBiblioteca`,
        `Nome`,
...
-- Populando a tabela Funcionario com mais nomes fictícios
INSERT INTO
    `Funcionario` (
        `CPF`,
        `biblioteca_id`,
...
-- Populando a tabela Livro com mais livros fictícios e atributos Titulo e Autor
INSERT INTO
    `Livro` (
        `idLivro`,
        `dataPublicacao`,
...
-- Populando a tabela Usuario com mais nomes fictícios
INSERT INTO
    `Usuario` (`CPF`, `Nome`, `Telefone`, `Endereco`)
VALUES
    (
...
-- Populando a tabela Compra com mais dados fictícios
INSERT INTO
    `Compra` (
        `dataCompra`,
        `CPF_Funcionario`,
...
-- Populando a tabela Emprestimo com mais dados fictícios
INSERT INTO
    `Emprestimo` (
        `CPF_Funcionario`,
        `CPF_Usuario`,
...
-- Populando a tabela Personagem com mais personagens fictícios
INSERT INTO
    `Personagem` (`idPersonagem`, `Nome`, `Sexo`)
VALUES
    (11, 'Greg', 'M'),
...
-- Populando a tabela LivrosEmBibliotecas com mais dados fictícios
INSERT INTO
    `LivrosEmBibliotecas` (`livro_id`, `biblioteca_id`, `Quantidade`)
VALUES
    (11, 11, 2),
...
-- Populando a tabela PersonagensEmLivros com mais dados fictícios
INSERT INTO
    `PersonagensEmLivros` (`livro_id`, `personagem_id`)
VALUES
    (11, 11),
