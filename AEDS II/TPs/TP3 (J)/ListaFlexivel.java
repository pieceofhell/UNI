...
public class ListaFlexivel{
    ...
    public class Lista{
        ...
        public void print(){
            ...
            int i = 0;
            while(aux != null){
                System.out.print("[" + i + "] ## " + aux.jogador.getNome() + " ## " + aux.jogador.getAltura() + " ## " + aux.jogador.getPeso() + " ## " + aux.jogador.getAnoNascimento() + " ## " + aux.jogador.getUniversidade() + " ## " + aux.jogador.getCidadeNascimento() + " ## " + aux.jogador.getEstadoNascimento() + " ##\n");
                aux = aux.next;
                i++;
            }
        }
    ...
    public static void main(String[] args){
        ...
        ListaFlexivel lf = new ListaFlexivel();
        Lista lista = lf.new Lista();
