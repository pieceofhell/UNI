...
class Lista {
  ...
  public Lista encontrarPorId(
    Lista omegaJogadores,
    Lista jogadoresTratados,
    int id
  ) {
  ...
  public Jogador encontrarPorId(Lista jogadoresTratados, int id) {
    for (
      Jogador i = jogadoresTratados.primeiro;
      i != jogadoresTratados.ultimo.prox;
      i = i.prox
    ) {
      if (i.getId() == id) {
        return i;
  ...
  public void inserir(Lista jogadores, int pos, Jogador jogador) {
    ...
    if (jogador == null) {
      System.out.println("Erro ao inserir jogador nulo!");
      return;
    }
    ...
    if (pos == 0) {
      inserirInicio(jogadores, jogador);
    } else if (pos == tamanho) {
      jogadores.inserirFim(jogador);
    } else {
      Jogador i = jogadores.primeiro;
      for (int j = 0; j < pos - 1; j++, i = i.prox) {
        if (i == null) {
          System.out.println("Erro ao percorrer a lista!");
          return;
        }
      }
    ...
    try {
      ...
      while (true) {
        ...
        jogadoresSelecionados =
          jogadoresSelecionados.encontrarPorId(
            omegaJogadores,
            jogadoresSelecionados,
            id
          );
      ...
      // PARTE 2 DO EXERCICIO (MANIPULACAO DA LISTA DE JOGADORES SELECIONADOS)
      ...
      for (int i = 0; i < numeroOperacoes; i++) {
        ...
        if (entrada.length == 3) {
          ...
          if (comando.equals("I*")) {
            ...
            jogadoresSelecionados.inserir(omegaJogadores, param1, jogador);
          }
        }
      }
